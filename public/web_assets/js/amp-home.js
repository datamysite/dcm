...
$(document).ready(function () {
  "use strict";
    ...
    $("#hcategory-slider").slick({infinite: true, slidesToShow: 6, slidesToScroll: 1, autoplay: false, dots: false, arrows: true, prevArrow: '<span class="slick-prev"><</span>', nextArrow: '<span class="slick-next">></span>', responsive: [{breakpoint: 1400, settings: {slidesToShow: 4, slidesToScroll: 4}}, {breakpoint: 820, settings: {slidesToShow: 4, slidesToScroll: 1}}, {breakpoint: 480, settings: {slidesToShow: 4, slidesToScroll: 1}}]});
