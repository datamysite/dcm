var host = $("meta[name='home_url']").attr("content");lazyload=0;
...
function getMenuCategories(){
	$.get(host+'/includes/getcategoriesDesktop', function(data){
		$('.desktopMenuCategories').html(data);
	});

	$.get(host+'/includes/getcategoriesMob', function(data){
		$('.mobMenuCategories').html(data);
	});
