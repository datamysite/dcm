               ...
               <div class="brand-item">
                  @foreach($onlinestores as $val)
                     <a href="{{route('brand', [$region, $val->retailer->slug])}}" class="img-pop-up" aria-label="Online Store - {{$val->retailer->name}}">
                        <amp-img class="img-fluid w-100" src="{{URL::to('/public/test-brand.png')}}" layout="responsive" width="185px" height="230px" alt="Store - {{$val->retailer->name}}" style="border-radius: 20px;"></amp-img>
               ...
               @if(count($retailstores) < 2)
                  <div class="brand-item">
                     ...
                     <a href="#" class="img-pop-up" aria-label="Online Store - {{$val->retailer->name}}">
                        <amp-img class="img-fluid w-100" src="{{URL::to('/public/test-brand.png')}}" layout="responsive" width="185px" height="230px" alt="Store Coming Soon" style="border-radius: 20px;"></amp-img>
            ...
            <div class="row">
               <div class="col-6">
                  <a href="{{route('brand', [$region, $allstores[1]->retailer->slug])}}" aria-label="All Store - {{$allstores[1]->retailer->name}}">
                     <div class="single-deal">
                        ...
                        <amp-img class="img-fluid w-100" src="{{URL::to('/public/test-brand.png')}}" alt="All Store - {{$allstores[1]->retailer->name}}" layout="responsive" width="185px" height="230.516px"  style="border-radius: 20px;"></amp-img>
                     </div>
                  </a>
               </div>
               ...
               <div class="col-6">
                  <a href="{{route('brand', [$region, $allstores[2]->retailer->slug])}}" aria-label="All Store - {{$allstores[2]->retailer->name}}">
                     <div class="single-deal">
                        <div class="overlay"></div>
                        <amp-img class="img-fluid w-100" src="{{URL::to('/public/test-brand.png')}}" alt="All Store - {{$allstores[2]->retailer->name}}" layout="responsive" width="185px" height="230.516px"  style="border-radius: 20px;"></amp-img>
                     </div>
                  </a>
               </div>
               ...
               <div class="col-12 mb-3">
                  <a href="{{route('brand', [$region, $allstores[0]->retailer->slug])}}" aria-label="All Store - {{$allstores[0]->retailer->name}}">
                     <div class="single-deal v-tile">
                        <div class="overlay"></div>
                        <amp-img class="img-fluid w-100" src="{{URL::to('/public/test-brand.png')}}" alt="All Store - {{$allstores[0]->retailer->name}}" layout="responsive" width="390px" height="240px"  style="border-radius: 20px;"></amp-img>
                     </div>
                  </a>
               </div>
