            ...
            <div class="modal-body">
               <div class="modal_container" id="modal_container">
                  ...
                  <div class="form-modal_container sign-in-modal_container">
                     <form action="{{route('user.login', [$region])}}" method="post" id="login_user_form" class="form_modal">
                        @csrf
   ...
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content p-4" style="background-color: #fff;">
         ...
         <div class="modal-body" style="text-align: center;">
            ...
            <form id="forgotPasswordForm" method="post" action="{{route('user.forgotPassword')}}">
               @csrf
               <div class="mb-3">
