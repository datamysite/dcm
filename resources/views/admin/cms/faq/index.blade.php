                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-1">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-primary pull-right" title="Add Blog" data-toggle="modal" data-target="#addBlogFormModal"><i class="fas fa-plus"></i> Add FAQs</a>
                                </div>
                            </div>
...
<script>
    ...
    $(function() {
        ...
        $(document).on('click', '.deleteFAQ', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.get("{{URL::to('/admin/panel/faq/delete')}}/" + id, function(data) {
                        Toast.fire({
                            icon: 'success',
        ...
        $(document).on('click', '.editFAQ', function() {
            ...
            $.get("{{URL::to('/admin/panel/faq/edit/')}}/" + val, function(data) {
