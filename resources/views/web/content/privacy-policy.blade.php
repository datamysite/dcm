            ...
            <div class="col-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="Blogs" style="color:#1DACE3;"><strong>Privacy-Policy</a></strong></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<section class="mt-2">
    <div class="container np-container">
        ...
        <div class="dcm_banner" style="background: url(./public/web_assets/images/banner/dcm_banner.png) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
            <h2 class="text-center" style="padding-top: 200px;color:#fff ;font-size:35px">Privacy-Policy</2>
        </div>

        <div class="dcm_banner_mobile">
            <h2 class="text-center" style="padding-top:40px;color:#fff">Privacy-Policy</2>
        </div>
