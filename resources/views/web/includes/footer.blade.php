   ...
   <div class="container">
      <div class="row g-4 py-4">
         ...
         <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-3">
               <h6 class="mb-4">Subscribe For Latest News and Updates</h6>
               <ul class="nav flex-column">
                  <!-- list -->
                     ...
                     <a href="#!" class="nav-link">
                        <form class="ms-auto d-flex align-items-center">
                           <div class="input-group">
                              ...
                              <button class="btn btn-outline-primary px-5 py-2" type="submit">
         ...
         <div class="row align-items-center">
            <div class="col-md-6">
               <span class="small text-muted" style="color: black;">
                  ...
                  <a href="https://www.dealsandcouponsmena.com/" style="color: black;">dealsandcouponsmena</a> All rights reserved.
               </span>
            </div>
