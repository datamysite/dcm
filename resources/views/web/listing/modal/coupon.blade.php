...
<div class="grap_deal_coupon">
  ...
  <div class="grap_deal_button">
     <a href="javascript:void(0)" class="grap_deal_btn" data-id="{{$coupon->id}}" data-href="{{empty($coupon->link) ? $coupon->retailer->store_link : $coupon->link}}{{$coupon->retailer->slug == 'sivvi' ? '' : '?utm_source=dealsandcouponsmena&utm_campaign=cps'}}"  onclick="return gtag_report_grabDeal;" id="popupButton">{{ __('translation.grab_deal') }}</a>
  </div>
</div>
