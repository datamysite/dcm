...
<div class="grap_deal_social offer_deal_social">
   <div>
     <a href="javascript::void()" data-href="{{route('offers.redeemPDF', [$region, base64_encode($qrid)])}}" onclick="return gtag_report_qrcodeDownload;" target="_blank" class="grap_deal_icon downloadQrcode">{{ __('translation.Download') }} &nbsp;<i class="fa fa-download"></i></a>
     |
