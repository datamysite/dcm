...
<div class="grap_deal_coupon">
  <div class="grap_deal_code">
     ...
     <h2>
        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->merge('https://dealsandcouponsmena.ae/public/web_assets/images/logo/logo-DCM.png', .2, true)->size(200)->generate('https://dealsandcouponsmena.ae')) !!} ">
     </h2>
  </div>
</div>
