   ...
   <section class="my-lg-12 my-8">
      <div class="container">
         ...
         <div class="category-slider" id="hcategory-slider" style="height: 101.578px;">
            ...
            @endphp
            <div class="item" style="height: 101.578px;">
               <a href="{{route('category', [$region, $slug])}}/?type={{$val->type == '3' ? '1' : '2'}}" class="text-decoration-none text-inherit " style="height: 101.578px;">
