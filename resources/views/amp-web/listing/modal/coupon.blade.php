...
<div class="grap_deal_coupon">
  ...
  <div class="grap_deal_button">
     <a href="javascript:void(0)" class="grap_deal_btn" data-id="{{$coupon->id}}" data-href="{{$coupon->link}}/?utm_source=dealsandcouponsmena&utm_campaign=cps" id="popupButton">{{ __('translation.grab_deal') }}</a>
  </div>
</div>
