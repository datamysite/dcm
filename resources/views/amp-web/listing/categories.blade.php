         ...
         <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb mb-0">
                  ...
                  <li class="breadcrumb-item active"><a href="javascript:void(0)"><strong>{{app()->getLocale() == 'ar' ? $category->name_ar : $category->name}}</strong></a></li>
               </ol>
            </nav>
         </div>
      </div>
         ...
         <div class="ccategory-slider category-slider">
            @foreach($categories as $val)
               ...
               <div class="item {{$val->id == $category->id ? 'active' : ''}}" style="height:101.578px">
                  <a href="{{route('category', [$region, $slug])}}" class="text-decoration-none text-inherit" style="height:101.578px">
