    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <span class="text-white text-underline"><a href="{{route('brand', ['en', Auth::guard('seller')->user()->retailer->states[0]->state->slug, Auth::guard('seller')->user()->retailer->slug])}}" target="_blank">Website &nbsp;<i class="fas fa-link"></i></span>
        </div>
      </div>
